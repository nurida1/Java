...
public class _78_Car_Insurance_Quote_StringMethods {
    public static void main(String[] args) {

        double premium = 0;       //amount to be paid for an insurance policy
        ...
        if (vehicleUsage.equalsIgnoreCase("business")) {
            ...
            premium += 5.0 * daysDrivenToWorkOrSchool;
        ...
        referenceNumber = name.charAt(0) + "" + name.charAt(1) + age +
                name.charAt(name.length()-2) + name.charAt(name.length()-1) +zipCode +
                education.replace(" ", "");
