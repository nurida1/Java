...
public class Arrays_Sorting {
    public static void main(String[] args) {
        ...
        Arrays.sort(arr1); //sorts from smallest to largest
        ...
        Arrays.sort(ch); //sorts by ascii table
        System.out.println(Arrays.toString(ch)); //A,B,D,D,E,W,Y,Z

        String[] names = {"Deniz", "Osman", "Rustem", "Anna", "Ali"}; //sequence of characters
        Arrays.sort(names);
