package OfficeHours.Practise_04_01_2020;
...
public class StringMethods {
 ...
 //       char ch2 = str1.charAt(4);  //out of range error message
        ...
        System.out.println(total);  //15  14 is maximum index number
        ...
        //toLowerCase() & toUpperCase(): change the case of the strings to upper or lower
        ...
        //substring (beginningINdex, ending index): creates substring from beginning index till ending index (ending is not included //excluded)
        ...
        //                  0123456789
        sentence2.substring(10); // "learn Java";
       ...
       t1 = t1.replaceFirst(", Java", ", C#");
        ...
        System.out.println(a1); //W=6(index number of W)
        System.out.println(a2); // second W index num
