...
public class salaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        int salary = input.nextInt();  //for salary it's better to use int

        System.out.println("Enter the state tax rate: ");
        byte stateTax = input.nextByte();  //
        double stateTaxPercentage = stateTax / 100.0 ; //devided by 100.0 in order to get percentage in decimal (math)
