...
public class BankOfAmerica {
    ...
    public static void main(String[] args) {
        ...
        tester2.setTesterInfo("Venera", 2345465, "Senior SDET", 130000);

        Tester tester3 = new Tester();
        tester3.setTesterInfo("Sha Rejepov", 62435, "SDET", 100000);

        Tester tester4 = new Tester();
        tester4.setTesterInfo("Muhtar", 111, "Manual Tester", 120000);

        Tester tester5 = new Tester();
        tester5.setTesterInfo("John", 2222, "Uber Driver", 60000);
