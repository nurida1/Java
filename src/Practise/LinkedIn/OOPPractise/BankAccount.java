...
public class BankAccount {
    ...
    public void deposit(int addMoney) { //setter
        if (addMoney < 0) {
            System.out.println("You cannot deposit a negative a negative amount");
        }else {
...
public void withdraw(int removeMoney) {
        if (removeMoney > this.account_balance) {
            ...
            this.account_balance = account_balance - removeMoney;
