...
public class VariablesPractise {
    public static void main(String[] args) {
       ...
       //salary after tax = salary(1-sum of taxes)
        ...
        int kg =90;  //or double
        double pound = kg * 2.25;  //pound because you multiple to decimal number
        System.out.println(pound);

        System.out.println("=============================================================");
        double lira = 1000;
        double liraInDollaar = lira / 6.15;
        System.out.println(liraInDollaar);
