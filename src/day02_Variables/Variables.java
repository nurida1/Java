...
public class Variables {
    public static void main(String[] args) {
        ...
        // byte num = 2.5; byte, short, int, long only accept whole numbers
...
//        long n3 = 9999999999 // out of int' range. compiler by default takes it as int.
        ...
        // int num = 7L; larger one cannot be assignet to smaller one
    ...
    //    byte b1 = s1; // short is larger than byte
      ...
      //byte b2 = i1; larger one cannot assign to smaller one

        System.out.println(3.5);
        double d1 = 3.5;

        // float f1 = 4.5; //double primitive is larger that float primitive, cannot assigned.
